...
class TavilPlaceSearchTool :
    def __init__(self) :
        pass
        
    def tavily_search_attractions(self, place : str) -> dict :
        """
        Searches for attractions in the specified places using TavilySearch
        """
    ...
    def tavily_search_restaurants(self, place : str) -> dict :
        """
        Searches for available restaurants in the specified places using TavilySearch
        """
        tavily_tool = TavilySearch(topic = "general", include_answer = "advanced")
    ...
    def tavily_search_activity(self, place : str) -> dict :
        """
        Searches for popular activities in the specified places using TavilySearch
        """
        tavily_tool = TavilySearch(topic = "general", include_answer = "advanced")
    ...
    def tavily_search_transportation(self, place : str) -> dict :
        """
        Searches for available modes of transportation in the specified places using TavilySearch
        """
        tavily_tool = TavilySearch(topic = "general", include_answer = "advanced")
